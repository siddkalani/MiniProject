...
const TableThree = () => {
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-3 shadow-default sm:px-8 xl:pb-1">
          ...
          <tbody>
            {packageData.map((packageItem, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <p
                    className={`inline-flex rounded-full bg-opacity-60 py-1 px-3 text-sm font-medium ${
                      packageItem.status === 'Paid'
                        ? 'bg-green-400 text-success'
                        : 'bg-red-500 text-warning'
                    }`}
                  >
                    {packageItem.status}
                  </p>
